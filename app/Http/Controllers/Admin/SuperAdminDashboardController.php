    ...
    public function index(Request $request)
{
    try {
        ...
        $chartQuery = DB::table('peserta_sertifikats as ps')
            ->join('certification_schemes as cs', 'ps.sertifikasi', '=', 'cs.nama')
            ->select('cs.code_1', DB::raw('COUNT(ps.id) as total_peserta'));
        ...
        $chartData = $chartQuery->groupBy('cs.code_1')
        ...
        $activityLogs = ActivityLog::whereBetween('created_at', [
