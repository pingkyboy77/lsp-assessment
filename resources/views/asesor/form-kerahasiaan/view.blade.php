{{-- resources/views/asesor/form-kerahasiaan/view.blade.php --}}
...
@push('scripts')
    <script>
        ...
        window.addEventListener('beforeprint', function() {
            document.querySelector('.form-view-container').style.background = 'white';
            document.querySelector('.form-view-container').style.padding = '0';
        });

        window.addEventListener('afterprint', function() {
            document.querySelector('.form-view-container').style.background =
                'linear-gradient(135deg, #667eea 0%, #764ba2 100%)';
            document.querySelector('.form-view-container').style.padding = '2rem';
        });
    </script>
@endpush