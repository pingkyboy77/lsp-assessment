            ...
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h5 class="mb-1 text-dark fw-bold">
                        <i class="bi bi-file-earmark-plus me-2"></i>Proses Perencanaan Asesmen - MAPA
                    </h5>
                    <p class="mb-0 text-muted">
                        Asesi: <strong>{{ $delegasi->asesi->name }}</strong> | 
                        Skema: <strong>{{ $delegasi->certificationScheme->nama }}</strong>
                    </p>
                </div>
        ...
        <div class="card-body m-3">
            ...
            <ul class="nav nav-tabs-custom mb-4" role="tablist">
                ...
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="planning-tab" data-bs-toggle="tab" data-bs-target="#planning-content"
                        type="button">
                        <i class="bi bi-calendar-check me-2"></i>Perencanaan MAPA
                    </button>
                </li>
            </ul>
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane fade show active" id="review-content">
                    ...
                    @include('asesor.mapa.partials.apl02-review', ['delegasi' => $delegasi, 'kelompokKerjas' => $kelompokKerjas])

                </div>

                <!-- TAB 2: PERENCANAAN MAPA -->
                        ...
                        <div class="info-box-mapa mb-4">
                            <div class="d-flex align-items-start">
                                ...
                                <div class="flex-grow-1">
                                    <h6>Petunjuk Perencanaan MAPA</h6>
                                    <ul class="small mb-0">
                        ...
                        <div class="card border-0 shadow-sm mb-4">
                            ...
                            <div class="card-body">
                                <textarea class="form-control" rows="4" name="catatan_asesor"
                                    ...
                                    style="border-color: var(--gray-300);"></textarea>
                            </div>
                        </div>
...
<script>
    ...
    function submitMapa() {
        ...
        Swal.fire({
            title: 'Simpan & Submit MAPA?',
            text: 'MAPA akan dikirim untuk direview oleh admin',
            icon: 'question',
    ...
    function processSubmit() {
        ...
        formData.append('submit_action', 'submit');
        ...
        fetch("{{ route('asesor.mapa.store', $delegasi->id) }}", {
                method: 'POST',
                body: formData,
                headers: {
                ...
                if (data.success) {
                    Swal.fire({
                        ...
                        html: `
                            <p>${data.message}</p>
                            <hr>
                            <p class="mb-1"><strong>Nomor MAPA:</strong> ${data.data.nomor_mapa}</p>
