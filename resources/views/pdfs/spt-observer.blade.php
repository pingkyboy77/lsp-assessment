{{-- File: resources/views/pdfs/spt-observer.blade.php --}}
<!DOCTYPE html>
<html>

<head>
    <meta charset="UTF-8">
    <title>SPT Observer</title>
    <style>
        @page {
            margin: 1.5cm 1.5cm;
        }
...
<body>
    ...
    <!-- ========== CONTENT ========== -->
    <div class="content">
        <p>Sehubungan dengan permohonan Observer Sewaktu Jarak Jauh LSP Pasar Modal. Maka LSP Pasar Modal menugaskan:</p>
    </div>
    ...
    <div class="info-box">
        <table class="info-table">
            <tr>
                ...
                <td class="info-value">{{ $observer_name }}</td>
            </tr>
            <tr>
                <td class="info-label">Nomor NIK</td>
                <td class="info-separator">:</td>
                <td class="info-value">{{ $observer_nik }}</td>
            </tr>
            <tr>
    ...
    <div class="content">
        <p>Untuk menjadi tim Observer Sewaktu Jarak Jauh</p>
