                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                <h5 class="mb-1 text-dark fw-bold">
                                    <i class="bi bi-diagram-3-fill me-2"></i>Tambah Bidang Sertifikasi
                                </h5>
                            </div>
                ...
                <div class="card-body m-3">
                    <form action="{{ route('admin.fields.store') }}" method="POST">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="kode_bidang" class="form-label">Kode Bidang <span class="text-danger">*</span></label>
                                    <input type="text" 
                                           class="form-control @error('kode_bidang') is-invalid @enderror" 
                                           id="kode_bidang" 
                                           name="kode_bidang" 
                                           value="{{ old('kode_bidang') }}" 
                                           required>
                                    @error('kode_bidang')
                                ...
                                <div class="mb-3">
                                    ...
                                    @error('code_2')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                    <div class="form-text">Maksimal 10 karakter, akan otomatis diubah ke huruf kapital</div>
                                </div>

                                <div class="mb-3">
                                    <label for="bidang" class="form-label">Nama Bidang <span class="text-danger">*</span></label>
                                    <input type="text" 
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" 
                                           class="form-control @error('bidang_ing') is-invalid @enderror" 
                                           id="bidang_ing" 
                                           name="bidang_ing" 
                                           value="{{ old('bidang_ing') }}">
                                    @error('bidang_ing')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" 
                                           class="form-control @error('kode_web') is-invalid @enderror" 
                                           id="kode_web" 
                                           name="kode_web" 
                                           value="{{ old('kode_web') }}">
                                    @error('kode_web')
