            ...
            <div class="d-flex justify-content-between align-items-center">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0">
                            ...
                            <li class="breadcrumb-item"><a
                                    href="{{ route('admin.certification-schemes.show', $scheme) }}">{{ Str::limit($scheme->nama, 30) }}</a>
                            </li>
                ...
                <div class="d-flex gap-2">
                    ...
                    <a href="{{ route('admin.schemes.kelompok-kerja.create', $scheme) }}"
                        class=" btn-primary-custom text-light" style="text-decoration: none">
        ...
        <div class="card-body m-3">
                ...
                <div class="d-flex align-items-center">
                    ...
                    <div class="flex-grow-1">
                        ...
                        <p class="mb-0">
                            ...
                            <span
                                class="badge bg-{{ $scheme->jenjang_color ?? 'secondary' }}">{{ $scheme->jenjang ?? 'Jenjang tidak tersedia' }}</span>
                        </p>
                    ...
                    <div class="col-md-4">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" id="search-input"
                                placeholder="Cari kelompok kerja..." onkeyup="filterKelompokKerja()">
                        </div>
                    </div>
                    ...
                    <div class="col-md-3 mt-3 mt-md-0">
                        <div class="d-flex justify-content-md-end gap-2">
                            ...
                            <a href="{{ route('admin.schemes.unit-kompetensi.index', $scheme) }}"
                                class="btn btn-outline-info btn-sm d-flex justify-content-center align-items-center gap-2">
            ...
            @if ($kelompoks->count() > 0)
                ...
                <div class="row" id="kelompok-grid">
                    @foreach ($kelompoks as $kelompok)
                        <div class="col-lg-6 col-xl-4 mb-4 kelompok-item" data-id="{{ $kelompok->id }}"
                            ...
                            <div class="card kelompok-card h-100">
                                    ...
                                    <div class="d-flex justify-content-between align-items-start">
                                        <div class="flex-grow-1">
                                            ...
                                            <div class="d-flex align-items-center gap-2">
                                                <span
                                                    class="badge bg-{{ $kelompok->is_active ? 'success' : 'secondary' }}">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end">
                                                <li>
                                                    <a class="dropdown-item"
                                                        href="{{ route('admin.schemes.kelompok-kerja.show', [$scheme, $kelompok]) }}">
                                                        <i class="bi bi-eye me-2"></i> Lihat Detail
                                                    </a>
                                                </li>
                                                <li>
                                                    <a class="dropdown-item"
                                                        href="{{ route('admin.schemes.kelompok-kerja.edit', [$scheme, $kelompok]) }}">
                                                        <i class="bi bi-pencil me-2"></i> Edit
                                                    </a>
                                                </li>
                                                <li>
                                                    <a class="dropdown-item"
                                                        href="{{ route('admin.schemes.kelompok-kerja.manage-unit-kompetensi', [$scheme, $kelompok]) }}">
                                                ...
                                                <li>
                                                    <button class="dropdown-item"
                                                        onclick="toggleStatus({{ $kelompok->id }})">
                                                        <i
                                                            class="bi bi-{{ $kelompok->is_active ? 'toggle-off' : 'toggle-on' }} me-2"></i>
                                                        {{ $kelompok->is_active ? 'Nonaktifkan' : 'Aktifkan' }}
                                                    </button>
                                                </li>
                                                <li>
                                                    <button class="dropdown-item text-danger"
                                                        onclick="deleteKelompok({{ $kelompok->id }})">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row text-center mb-3">
                                        <div class="col-6">
                                            <div class="stat-item">
                                                <div class="stat-number">{{ $kelompok->unitKompetensis->count() ?? 0 }}
                                                </div>
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <div class="mt-2">
                                            <small class="text-info me-3">
                                                ...
                                                {{ $kelompok->unitKompetensis->count() ?? 0 }} Unit Kompetensi
                                            </small>
                                            @if (isset($kelompok->active_bukti_count))
                                                <small class="text-info">
                                                    <i class="bi bi-folder-open"></i> {{ $kelompok->active_bukti_count }}
                                                    Bukti Portofolio
                                                </small>
                                            @endif
                                        </div>
            ...
            @else
                ...
                <<div class="d-flex flex-column align-items-center justify-content-center py-5">
                    ...
                    <h5 class="mb-2 text-center">Belum ada Kelompok Kerja</h5>
                    <p class="text-center text-muted mb-4">
                        Mulai dengan membuat kelompok kerja pertama untuk skema sertifikasi ini.
                    </p>
                    <a href="{{ route('admin.schemes.kelompok-kerja.create', $scheme) }}"
                        class=" btn-primary-custom d-flex align-items-center px-4 py-2">
                        <i class="bi bi-plus me-2 fs-4"></i> Tambah Kelompok Kerja
                    </a>
        </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <p class="text-danger">
                        <strong>Peringatan:</strong> Semua relasi dengan unit kompetensi dan bukti portofolio akan ikut
                        terhapus.
                    </p>
                </div>
